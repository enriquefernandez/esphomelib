#ifndef ESPHOMELIB_ADDRESSABLE_LIGHT_H
#define ESPHOMELIB_ADDRESSABLE_LIGHT_H
...
#include "esphomelib/light/addressable_light.tcc"

#endif //USE_LIGHT

#endif //ESPHOMELIB_ADDRESSABLE_LIGHT_H
